...
export default function Schedule() {
  ...
  useEffect(() => {
    ...
    const thisWeeksAvailabilityPath = `../../Quick-Lists/json/weekly_availability_${thisWeek}.json`;
    const nextWeeksAvailabilityPath = `../../Quick-Lists/json/weekly_availability_${nextWeek}.json`;
